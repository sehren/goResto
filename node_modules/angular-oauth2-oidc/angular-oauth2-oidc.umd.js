...
var OAuthService = (function (_super) {
     ...
     * @param {?} urlHelper
     */
    function OAuthService(http, storage, tokenValidationHandler, config, urlHelper) {
         ...
         */
        _this.state = '';
        _this.eventsSubject = new rxjs_Subject.Subject();
        _this.discoveryDocumentLoadedSubject = new rxjs_Subject.Subject();
     ...
     * @return {?}
     */
    OAuthService.prototype.loadDiscoveryDocumentAndTryLogin = function () {
        var _this = this;
...
OAuthService.ctorParameters = function () { return [
    ...
    { type: OAuthStorage, decorators: [{ type: _angular_core.Optional },] },
    { type: ValidationHandler, decorators: [{ type: _angular_core.Optional },] },
    { type: AuthConfig, decorators: [{ type: _angular_core.Optional },] },
...
var AUTH_CONFIG = new _angular_core.InjectionToken('AUTH_CONFIG');
