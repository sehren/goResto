...
var SuperTabsController = (function () {
    ...
    /**
       ...
       * @param [tabsId]
       */
    SuperTabsController.prototype.enableTabsSwipe = /**
       * Enables/disables swiping on a specific tabs instance
       * @param enable
       * @param [tabsId]
       */
    function (enable, tabsId) {
        var instance = this.getInstance(tabsId);
    ...
    /**
       ...
       * @param [tabsId]
       */
    SuperTabsController.prototype.enableTabSwipe = /**
       * Enables/disables swiping when this tab is active
       * @param tabId
       * @param enable
       * @param [tabsId]
       */
    function (tabId, enable, tabsId) {
        var instance = this.getInstance(tabsId);
    ...
    /**
       * @private
       */
    SuperTabsController.prototype.registerInstance = /**
       * @private
       */
    function (instance) {
    ...
    /**
       * @private
       */
    SuperTabsController.prototype.unregisterInstance = /**
       * @private
       */
    function (id) {
